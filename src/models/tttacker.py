...
class TTTackerNF(BaseNF):
    def __init__(
        ...
        **kwargs,
        ...
        super(TTTackerNF, self).__init__(dim_grid, dim_payload, **kwargs)
        ...
        self.B = nn.Bilinear(self.rank, self.rank, self.output_features, bias=True)
    ...
    def sample_tensor_points(self, coords_xyz):
        ...
        older_xyz = coords_xyz / self.dim_grid * 2 - 1
        younger_xyz = (coords_xyz % self.younger_size) / self.younger_size * 2 - 1
